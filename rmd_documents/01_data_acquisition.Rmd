...
# rm(packages)
# 
# write_rds(packages_info, here::here("data", "produced", "packages_basic_info.Rdata"))
```
...
# close(pb)
# 
# write_rds(list_metadata, here::here("data", "produced", "metadata_all_packages.Rdata"))
```
...
# rm(i, link)
# 
# write_rds(package_views, here::here("data", "produced", "package_cran_views.RData"))
```
